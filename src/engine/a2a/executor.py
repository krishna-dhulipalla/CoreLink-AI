...
from engine.agent.benchmarks import verify_officeqa_competition_bootstrap
from engine.agent.model_config import startup_compatibility_warnings, startup_model_summary
from engine.agent.tracer import write_preflight_failure_trace
from engine.runtime.conversation_store import ConversationStore
from engine.mcp.judge_mcp_bridge import JudgeMcpConnectionError, load_judge_tools_for_session
from engine.mcp.mcp_client import judge_mcp_discovery_enabled, load_mcp_tools_from_env
...
class Executor(AgentExecutor):
    ...
    def __init__(self):
        ...
        logger.info("[ModelConfig] Active startup model map: %s", startup_model_summary())
