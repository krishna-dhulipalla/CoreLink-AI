...
from engine.agent.context import evidence as _evidence
from engine.agent.context.extraction import derive_market_snapshot, extract_as_of_date, extract_entities, extract_formulas, extract_urls, parse_markdown_tables
from engine.agent.context.profiling import (
    ...
    infer_benchmark_overrides,
    infer_task_profile,
    latest_human_text,
    normalize_whitespace,
)
from engine.agent.context.stages import (
