...
from engine.agent.contracts import OfficeQAComputeResult, OfficeQAComputeStep, RetrievalIntent
...
def compact_officeqa_compute_result(payload: dict[str, Any] | None) -> dict[str, Any]:
    ...
    return {
        ...
        "capability_source": str(data.get("capability_source", "")),
        "capability_signature": str(data.get("capability_signature", "")),
        "capability_validated": bool(data.get("capability_validated")),
