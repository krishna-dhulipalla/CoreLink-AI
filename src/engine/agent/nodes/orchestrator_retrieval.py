...
from engine.agent.benchmarks import benchmark_runtime_policy
from engine.agent.contracts import ExecutionJournal, RetrievalAction, RetrievalIntent, SourceBundle, ToolPlan
from engine.agent.officeqa_strategy_planner import (
    OfficeQAPlannerOps,
...
from engine.agent.retrieval_candidates import (
...
from engine.agent.retrieval_retry_policy import (
...
from engine.agent.retrieval_tool_runtime import (
...
from engine.agent.retrieval_reasoning import assess_evidence_sufficiency
from engine.agent.strategy_journal import recommend_strategy_order
...
def _plan_retrieval_action(
    *,
    ...
    for index, requested_strategy in enumerate(ordered_candidates):
        ...
        duplicate_requested = (strategy_name in attempted_current_regime) or any(
