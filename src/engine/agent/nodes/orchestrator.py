...
from engine.agent.context.evidence import _extract_policy_context
from engine.agent.context.extraction import derive_market_snapshot
from engine.agent.compute_capability import maybe_acquire_officeqa_compute_result
from engine.agent.model_config import ChatOpenAI, get_client_kwargs, get_model_name, get_model_name_for_task, get_model_runtime_kwargs, invoke_structured_output
...
from engine.agent.runtime_support import latest_human_text
from engine.agent.solver.options import (
    deterministic_options_final_answer,
    deterministic_policy_options_final_answer,
)
from engine.agent.solver.quant import deterministic_quant_final_answer
from engine.agent.strategy_journal import record_strategy_outcome, strategy_journal_snapshot
from engine.agent.tracer import format_messages_for_trace, get_tracer
from engine.agent.capabilities import resolve_tool_plan
from engine.agent.benchmarks.officeqa_validator import officeqa_orchestration_strategy
from engine.agent.benchmarks import benchmark_compute_result, benchmark_task_intent, benchmark_validate_final
from engine.agent.curated_context import (
...
from engine.agent.nodes.orchestrator_intent import (
    _heuristic_intent,
    _normalize_task_intent,
    _supports_options_fast_path,
    _template_stub,
)
from engine.agent.nodes.orchestrator_retrieval import (
...
from engine.agent.review_utils import looks_truncated, matches_exact_json_contract
from engine.agent.retrieval_reasoning import assess_evidence_sufficiency, predictive_evidence_gaps
from engine.agent.state import AgentState
from engine.runtime.context_manager import count_tokens
